...
* Estruturação de dados no Excel com foco em usabilidade;
* Criação de menus e navegação por hiperlinks;
* Uso de validações automáticas e proteções de célula;
...
🔗 Link do Projeto
➡️ https://github.com/M4rinheiro/Organizador-Imposto-de-Renda---Excel
